...
| Frontend/wallet | 39 pass, covering the mandatory injected-wallet provider gate, automatic same-hash timeout reconciliation, and exact-provider write binding |
