...
| Frontend/wallet | 43 pass, covering the mandatory injected-wallet provider gate, explicit-finality full-receipt classification, transaction-specific create readback, direct transaction-by-hash reconciliation, and exact-provider write binding |
